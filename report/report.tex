...
For the cities, some more creativity was needed to match some of the cities up after the bulk of them were matched automatically.

To resolve the entities I built a map with words to look for in the menu name back to the ontology URL.
