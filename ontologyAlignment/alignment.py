...
"""The URL for my ontology"""
pizza_url = 'http://www.co-ode.org/ontologies/pizza/pizza.owl#'
"""The URL for the pizza.owl ontology"""
pizza_ontology_loc = os.path.join('orgData', 'pizza.owl')
"""Where the pizza ontology is"""

dest_mini = os.path.join('ontologyAlignment', 'miniAlignedOntology.ttl')
dest_main = os.path.join('ontologyAlignment', 'mainAlignedOntology.ttl')


def main(destination_mini: str = dest_mini,
         destination_main: str = dest_main) -> None:
    """This maps my ontology with the pizza.owl ontology.
    I used Protegé to import the Pizza.owl ontology into ontology.owl.

    Parameters
    ----------
    destination_mini: str
        Where the mini ontology goes

    destination_main: str
        Where the main ontology goes

    Returns
    -------
    None
        Saves the combined ontology to destination_main.
        The mini ontology goes to destination_mini"""
    ...
    mini_aligned.serialize(format='ttl', destination=destination_mini)
    main_aligned.serialize(format='ttl', destination=destination_main)
